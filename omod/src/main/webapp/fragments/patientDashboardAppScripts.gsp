			...
			jq.ajax({
					...
					data: {
						note: ko.toJSON(note, ["label", "id", "admitted","provisional","onSetDate",
							...
							"presentingComplains", "historyOfPresentIllness", "pastMedicalSurgicalHistory", "cns", "cvs", "rs", "gus", "mss","generalExamination", 
							"jaundiceExamination", "anaemiaExamination", "cyanosisExamination", "clubbingExamination", "oedemaExamination", "dehydrationExamination",
							...
							"rsInspection", "rsPalpation", "rsPercussion", "rsAuscultation","asInspection", "asPalpation", "asPercussion", "asAuscultation", "breastExaminationComment", "csInspection", "csPalpation", "csPercussion", "csAuscultation",
